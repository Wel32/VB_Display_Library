...
const hal_pwm_channel_t lcd_bl_pwm_channel_data = 
{
    {GPIO_NUM_2,                  /*!< the LEDC output gpio_num, if you want to use gpio16, gpio_num = 16 */
    LEDC_HIGH_SPEED_MODE,         /*!< LEDC speed speed_mode, high-speed mode or low-speed mode */
...
const hal_pwm_channel_t* lcd_bl_pwm_channel = &lcd_bl_pwm_channel_data;
...
const hal_gpio_num_t lcd_dc_gpio = GPIO_NUM_5;
